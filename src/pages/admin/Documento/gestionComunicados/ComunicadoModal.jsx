...
import PdfPreviewTW from '../PdfPreviewTW.jsx';
import InputField from '@components/InputField';

import { ComunicadoServices } from '../../../../service/Documentos/Comunicado.services.js';
import { NoticiaComunicadoSchema } from '@schema/documentos/NoticiasComunicado.schema.js';
...
export default function PoliticaModal({
  ...
  const validate = () => {
    const result = NoticiaComunicadoSchema.safeParse(form);
        ...
        <div className="px-5 py-5">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            {isEditing ? (
              previewUrl ? (
                ...
                <PdfPreviewTW
                  documentoId={id}
                  getDocument={ComunicadoServices.viewDocumeto}
                />
              )
            ) : previewUrl ? (
              <div className="h-100 overflow-hidden rounded-2xl border border-slate-200 bg-white">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            {isEditing ? (
              imagePreviewUrl ? (
              ...
              ) : ComunicadoServices?.getImageUrl ? (
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                  <img
                    src={ComunicadoServices.getImageUrl(id, imageVersion)}
                    alt="Imagen actual"
                    className="h-72 w-full object-contain bg-slate-100"
                    onError={(e) => {
                ...
                <div className="flex h-40 items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-4 text-center">
                  <p className="text-sm text-slate-600">
                    No se configuró
                    <strong>NoticiaServices.getImagenUrl</strong> para mostrar
