...
import { ProcesosServices } from '../../../../../../service/Documentos/gestionSeguridad/Procedimiento';
import { ProcedimientoSchema } from '@schema/documentos/gestionIsos/Procedimiento.schema.js';
...
export default function ProcedimientoModal({
  ...
  const validate = () => {
    const result = ProcedimientoSchema.safeParse(form);
        ...
        <div className="px-5 py-5">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            {isEditing ? (
              ...
              ) : ProcesosServices?.getImageUrl ? (
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                  <img
                    src={ProcesosServices.getImageUrl(id, imageVersion)}
                    alt="Imagen actual"
                    className="h-72 w-full object-contain bg-slate-100"
                    onError={(e) => {
