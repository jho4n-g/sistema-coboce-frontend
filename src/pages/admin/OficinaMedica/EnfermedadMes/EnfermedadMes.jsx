...
import { EnfermedadesMesServices as services } from '../../../../service/OficinaMedica/EnfermedadesMes.services.js';
import EnfermedadMesModal from './EnfermedadMesModal.jsx';
import { periodoATexto } from '../../../../helpers/normalze.helpers.js';
...
export default function EnfermedadMes() {
  ...
  return (
    <>
      <TablaRetutilizable
        ...
        titulo="Gestion de enfermedades por mes"
        datosBusqueda={['periodo', 'titulo', 'casos']}
        columnas={columnas}
        isDetalle={false}
        handleDetail={() => {}}
