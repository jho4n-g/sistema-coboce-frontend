...
import { PeriodoMetrosSchema as schema } from '../../../../../../schema/gestionVaon/PeriodoMetros/PeriodoMetros.schema.js';
...
export default function InsumoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-h-[calc(100vh-2rem)] w-[92%] max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-xl ring-1 ring-slate-200">
