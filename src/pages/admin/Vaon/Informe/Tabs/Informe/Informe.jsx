...
import { InformeServices as services } from '@service/GestionVaon/Informe.services.js';
import InformeModal from './InformeModal';
import InformeDetallesModa from './InformeDetallesModa';
...
const columnas = [
  ...
  { label: 'Metros²', key: 'metros_formato' },
];
  ...
  return (
    <>
      ...
      <InformeDetallesModa
        ...
        id={idDetalles}
        fetchById={services.getIdCostos}
      />
    </>
  );
}
