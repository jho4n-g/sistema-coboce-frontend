...
import { EnergiaElectricaServices as services } from '@service/GestionVaon/ProduccionNacional/Insumos/EnergiaElectrica.services.js';
import EnergiaElectricaModal from './EnergiaElectricaModal';
import EnergiaElectricaDetallesModa from './EnergiaElectricaDetallesModa';
...
const columnas = [
  ...
  { label: 'Consumo [kw]', key: 'consumo_kw' },
  { label: 'Consumo [Bs]', key: 'consumo_bs' },
];

export default function EnergiaElectrica() {
  ...
  return (
    <>
      <TablaRetutilizable
        ...
        titulo="Produccion nacional/ Energia electrica"
