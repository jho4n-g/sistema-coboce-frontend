...
import { AguaServices as sevices } from '../../../../../../service/GestionVaon/ProduccionNacional/Insumos/Agua.services.js';
import { AguaSchema as schema } from '@schema/gestionVaon/ProduccionNacional/Insumos/Agua.schema.js';
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
              ...
              <div className="md:col-span-3">
                <InputField
                  label="Consumo mensual [Ltrs]"
                  name="consumo_litros"
                  type="number"
                  value={form?.consumo_litros || ''}
                  onChange={updateBase}
                  error={error.consumo_litros}
                />
              </div>

              <div className="md:col-span-3">
                <InputField
                  label="Precion mensual [Bs]"
                  name="precio_total"
                  type="number"
                  value={form?.precio_total || ''}
                  onChange={updateBase}
                  error={error.precio_total}
                />
              </div>
