...
import { TranspArcillaServices as services } from '@service/GestionVaon/ProduccionNacional/Insumos/TranspAricilla.services.js';
import TranspArcillaModal from './TranspArcillaModal';
import TranspDetallesModa from './TranspDetallesModa';
...
const columnas = [
  ...
  { label: 'Consumo [kg]', key: 'consumo_kg' },
  { label: 'Consumo [Bs]', key: 'consumo_bs' },
];

export default function TranspArcilla() {
  ...
  return (
    <>
      <TablaRetutilizable
        ...
        titulo="Produccion nacional/ Transp Arcilla"
