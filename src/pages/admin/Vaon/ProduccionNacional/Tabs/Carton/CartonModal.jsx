...
import { CartonServices as sevices } from '../../../../../../service/GestionVaon/ProduccionNacional/Insumos/Carton.services.js';
import { CartonSchema as schema } from '@schema/gestionVaon/ProduccionNacional/Insumos/Carton.schema.js';

const initialForm = () => ({
  periodo: '',
  costo_unitario_caja: '',
  metros_cuadrados_caja: '',
});
...
export default function AguaModal({
  open,
  onClose,
  fetchById,
  isEditing,
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
              ...
              <div className="md:col-span-7">
                <InputField
                  label="Costo unitario caja"
                  name="costo_unitario_caja"
                  type="number"
                  value={form?.costo_unitario_caja || ''}
                  onChange={updateBase}
                  error={error.costo_unitario_caja}
                />
              </div>

              <div className="md:col-span-3">
                <InputField
                  label="Metros cuadrados caja"
                  name="metros_cuadrados_caja"
                  type="number"
                  value={form?.metros_cuadrados_caja || ''}
                  onChange={updateBase}
                  error={error.metros_cuadrados_caja}
                />
              </div>
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            {isEditing ? (
              previewUrl ? (
                ...
                <PdfPreviewTW
                  documentoId={id}
                  getDocument={sevices.viewDocumeto}
                />
              )
            ) : previewUrl ? (
              <div className="h-100 overflow-hidden rounded-2xl border border-slate-200 bg-white">
