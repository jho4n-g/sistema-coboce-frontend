...
import { ManoObraServices as services } from '@service/GestionVaon/ProduccionNacional/ManoObra/ManoObra.services.js';
import ManoObraModal from './ManoObraModal';
import ManoObraDetallesModa from './ManoObraDetallesModa';
...
const columnas = [
  ...
  { label: 'Metros²', key: 'metros_cuadrados' },
  ...
  return (
    <>
      <TablaRetutilizable
        ...
        titulo="Produccion nacional/ Mano obra"
