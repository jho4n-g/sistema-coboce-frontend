...
import { GasNaturalServices as services } from '@service/GestionVaon/ProduccionNacional/Insumos/GasNatural.services.js';
import GasNaturalModal from './GasNaturalModal';
import GasNaturalDetallesModa from './GasNaturalDetallesModa';
...
const columnas = [
  ...
  { label: 'Consumo [psc]', key: 'consumo_psc' },
  ...
  return (
    <>
      <TablaRetutilizable
        ...
        titulo="Produccion nacional/ Gas natural"
