...
import { GasNaturalSchema as schema } from '@schema/gestionVaon/ProduccionNacional/Insumos/GasNatural.schema.js';
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
              ...
              <div className="md:col-span-7">
                <InputField
                  ...
                  name="consumo_psc"
                  type="number"
                  value={form?.consumo_psc || ''}
                  onChange={updateBase}
                  error={error.consumo_psc}
                />
              </div>
