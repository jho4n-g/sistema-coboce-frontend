  ...
  return (
    <>
      <div className="flex items-start justify-between border-b border-slate-200 px-5 py-4">
        <h3 className="text-lg font-semibold text-slate-900">Prensado Modal</h3>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className="md:col-span-2 lg:col-span-6">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {(form?.observaciones_prensado_secado ?? []).map((item, idx) => (
                <span
                  key={idx}
              ...
              <tr key={idx} className="border border-slate-300 p-3">
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_uno', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_dos', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_tres', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_cuatro', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_cinco', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_seis', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'masa_molde_siete', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'espesor_molde_uno_a', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'espesor_molde_uno_b', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'espesor_molde_dos_a', e.target.value);
                    }}
                ...
                <td className="p-2 border-r border-slate-300">
                  <InputField
                    ...
                    onChange={(e) => {
                      setCargaTabla(idx, 'espesor_molde_dos_b', e.target.value);
                    }}
